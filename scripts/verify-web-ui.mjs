...
await waitForValue(() => evaluate(`Boolean(document.querySelector('[data-activity-dashboard].us-nav'))`), 'sidebar entry')
await evaluate(`document.querySelector('[data-activity-dashboard].us-nav').click()`)
