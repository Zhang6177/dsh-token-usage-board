## =============================================================================
# dsh-usage-stats 一键安装脚本（官方 CLI 方式，Windows PowerShell 5.1+ / pwsh）
#
# 通过 DSH 官方插件命令安装 npm 包并自动挂载：
#   dsh plugin --profile web add dsh-usage-stats@<version>
#
...
# 用法（任选其一）：
#   # 默认最新版
#   $script = (irm 'https://raw.githubusercontent.com/lanlandeli/dsh-usage-stats/main/scripts/install.ps1').TrimStart([char]0xFEFF)
...
# - 回滚：dsh plugin --profile web remove dsh-usage-stats
# =============================================================================
param(
  [string]$Version = '',
  [switch]$Restart,
